...
\TLV
   ...
   |cpu
      ...
      @1
         ...
         $inc_pc[31:0] = $pc + 32'd4; //Instruction Fetch
         ...
         `BOGUS_USE($is_load $is_sw $is_sh $is_sb $is_jalr $is_jal $is_auipc $is_lui $is_and $is_or $is_sra $is_srl $is_xor 
                    $is_sltu $is_slt $is_sll $is_sub $is_srai $is_srli $is_slli $is_andi $is_ori $is_xori $is_sltiu
                    $is_slti $is_addi $is_add $is_beq $is_blt $is_bltu $is_bgeu $is_bne $is_bge)
