...
\TLV
   ...
   |cpu
      ...
      @1
         ...
         `BOGUS_USE($is_addi $is_add $is_beq $is_blt $is_bltu $is_bgeu $is_bne $is_bge)
      ...
      @3   
         ...
         //Register File Write
         $rf_wr_en = ($rd[4:0] != 5'b0) && ($rd_valid) && ($valid); //Disable Write when $rd is 0 and Enable when it is Valid
         ?$rf_wr_en
